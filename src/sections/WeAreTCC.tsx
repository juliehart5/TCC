...
export function WeAreTCC() {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col justify-center min-h-screen px-6 sm:px-12 lg:px-[6vw]">
        {/* Headline */}
        <h2 
        ...
        {/* Body */}
        <p 
          className={`mt-8 max-w-xl text-[clamp(14px,1.2vw,16px)] text-[#B9B5AD] leading-relaxed transition-all duration-1000 delay-200 ${
        ...
        {/* Partners */}
        <div 
          className={`mt-16 flex flex-col sm:flex-row gap-8 sm:gap-16 transition-all duration-1000 delay-400 ${
        ...
        {/* Consultants */}
        <div 
          className={`mt-12 flex flex-col sm:flex-row gap-8 sm:gap-16 transition-all duration-1000 delay-600 ${
            isRevealed ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}
        >
          <div>
