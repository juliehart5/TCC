  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[60vh] lg:min-h-screen px-6 text-center">
        ...
        {/* Principles */}
        <div
          className={`mt-16 grid grid-cols-2 sm:grid-cols-4 gap-8 transition-all duration-1000 delay-400 ${isRevealed ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}
        >
