  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[60vh] lg:min-h-screen px-6 text-center">
        {/* Headline */}
        <h2
          className={`font-display text-[clamp(36px,6vw,90px)] text-[#F7F7F5] uppercase tracking-[-0.03em] leading-[0.95] transition-all duration-1000 ${isRevealed ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-16'
            }`}
        >
        ...
        {/* Stats */}
        <div
          className={`mt-16 grid grid-cols-3 gap-8 sm:gap-16 transition-all duration-1000 delay-400 ${isRevealed ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}
        >
