  ...
  return (
    ...
    >
      <div className="relative z-10 px-6 sm:px-12 lg:px-[6vw]">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <form 
            ...
            className={`space-y-6 transition-all duration-1000 delay-200 ${
              formRevealed ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'
            }`}
          >
        ...
        {/* Footer */}
        <div 
          className={`mt-24 pt-8 border-t border-[#F7F7F5]/10 flex flex-col sm:flex-row justify-between items-center gap-4 transition-all duration-1000 delay-400 ${
