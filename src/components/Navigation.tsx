...
export function Navigation() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Overlay */}
      <div 
        className={`fixed inset-0 bg-[#0B0C0E]/95 backdrop-blur-lg z-40 transition-all duration-300 sm:hidden flex flex-col items-center justify-center gap-8 ${
